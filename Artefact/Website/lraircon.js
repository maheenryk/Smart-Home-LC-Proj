...
var myDB = firebase.database().ref("AirConStatus/ Living Room");
var light = firebase.database().ref("LightStatus/ Living Room");
var win = firebase.database().ref("WindowStatus/ Living Room");
var blinds = firebase.database().ref("BlindsStatus/ Living Room");
