...
var myDB = firebase.database().ref("AirConStatus/ Kitchen");
var light = firebase.database().ref("LightStatus/ Kitchen");
var win = firebase.database().ref("WindowStatus/ Kitchen");
var blinds = firebase.database().ref("BlindsStatus/ Kitchen");
